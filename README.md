...
- <a href="./Code/Attack%20baselines/">Attack baselines</a>: Contains baseline implementations of traditional adversarial prompt generation techniques, serving as benchmarks to compare against persuasion-aware jailbreak methods.
  
- <a href="./Code/Defense%20baselines/">Defense baselines</a>: Includes implementations of defense strategies used to evaluate the robustness of LLMs against persuasion-based attacks.
