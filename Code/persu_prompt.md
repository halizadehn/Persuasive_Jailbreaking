...
- You must **clearly incorporate the persuasive strategy** of each principle in the rewritten request.  
- The **original meaning** must remain the same.  
- Each rewritten request must be a **complete and self-contained request**.  
